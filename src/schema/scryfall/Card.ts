...
const CardSchema = z
  .object({
    ...
    legalities: z.record(FormatSchema, LegalitySchema).transform(camelize),
    ...
    oversized: z.boolean(),
    prices: z.record(PriceSchema, z.string().nullable()).transform(camelize),
    ...
    purchase_uris: z.record(z.string(), z.string().url()).transform(camelize).nullish(),
    rarity: RaritySchema,
    related_uris: z.record(z.string(), z.string().url()).transform(camelize),
    ...
    'preview.previewed_at': z.coerce.date().nullish(),
